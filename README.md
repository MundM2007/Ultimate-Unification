...
To Generate all the Kubejs scripts aswell as asset files run the game once and then the main.py file in the unification folder.

## Required Mods

- [KubeJS](https://www.curseforge.com/minecraft/mc-mods/kubejs)
- [LootJS](https://www.curseforge.com/minecraft/mc-mods/lootjs)
- [Load My Resources (if not configured otherwise)](https://www.curseforge.com/minecraft/mc-mods/load-my-resources-forge)
- [KubeJS Blood Magic (if Blood Magic is installed)](https://www.curseforge.com/minecraft/mc-mods/kubejs-blood-magic)
- [KubeJS Create (if Create is installed)](https://www.curseforge.com/minecraft/mc-mods/kubejs-create)
- [KubeJS Immersive Engineering (if Immersive Engineering is installed)](https://www.curseforge.com/minecraft/mc-mods/kubejs-immersive-engineering)
- [KubeJS Mekanism (if Mekanism is installed)](https://www.curseforge.com/minecraft/mc-mods/kubejs-mekanism)
- [KubeJS Thermal (if Thermal is installed)](https://www.curseforge.com/minecraft/mc-mods/kubejs-thermal)
...
- [Better End Potato Edition](https://www.curseforge.com/minecraft/mc-mods/better-end-potato-edition)
...
- [DivineRPG](https://www.curseforge.com/minecraft/mc-mods/official-divinerpg)
...
- [Ex Nihilo: Sequentia](https://www.curseforge.com/minecraft/mc-mods/exnihilosequentia)
- [Ex Nihilo: Sequentia - AE2 Addon](https://www.curseforge.com/minecraft/mc-mods/ex-nihilo-sequentia-ae2-addon)
- [Ex Nihilo: Sequentia - Mekanism Addon](https://www.curseforge.com/minecraft/mc-mods/ex-nihilo-sequentia-mekanism-addon)
- [Ex Nihilo: Sequentia - Thermal Addon](https://www.curseforge.com/minecraft/mc-mods/ex-nihilo-sequentia-thermal-addon)
- [Ex Nihilo: Sequentia - Tinkers Addon](https://www.curseforge.com/minecraft/mc-mods/ex-nihilo-sequentia-tinkers-addon)
...
- [FTB Jar Mod](https://www.curseforge.com/minecraft/mc-mods/ftb-jar-mod-forge)
...
- [Mini Utilities](https://www.curseforge.com/minecraft/mc-mods/miniutilities)
...
- [Powah: Overcharged](https://www.curseforge.com/minecraft/mc-mods/powah-overcharged)
...
- [Space Boss Tools](https://www.curseforge.com/minecraft/mc-mods/beyond-earth)
- [Space Boss Tools: Giselle Addon](https://www.curseforge.com/minecraft/mc-mods/space-bosstools-giselle-addon)
